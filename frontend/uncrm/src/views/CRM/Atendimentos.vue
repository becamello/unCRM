...
export default {
  ...
  data() {
    return {
      ...
      pessoas: [],
      headers: [
        { text: "Código", value: "idFormatado", width: "7vw" },
        {
          text: "Tipo de atendimento",
          value: "tipoAtendimentoDescricao",
          width: "15vw",
        },
        { text: "Pessoa", value: "pessoaNome", width: "19vw" },
        {
          text: "Próximo contato",
          value: "proximoContato.descricao",
          width: "18vw",
        },
        { text: "Cadastro", value: "dataUsuarioCadastro", width: "18vw" },
        { text: "Status", value: "statusItem", align: "center", width: "8vw" },
