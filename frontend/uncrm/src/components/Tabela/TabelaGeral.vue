<template>
    <v-data-table :headers="headers" :items="items" :items-per-page="-1" class="elevation-0 custom-scroll" no-title
        fixed-header :height="height" :hide-default-footer="hideFooter">
